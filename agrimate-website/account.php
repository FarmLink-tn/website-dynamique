            ...
            <div class="container mx-auto px-6 text-center">
                ...
                <div class="max-w-xl mx-auto control-card mt-12">
                    <div id="auth-section">
                        ...
                        <p class="mt-4 text-text-300" data-translate="auth_register_prompt">Pas encore de compte ? <a href="/register.php" class="text-brand-green-400 font-bold">Créer un compte</a></p>
                    </div>
