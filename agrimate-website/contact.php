                ...
                <div class="max-w-2xl mx-auto control-card mt-12 text-left">
                    ...
                    <form id="contact-form" action="server/contact.php" method="POST" aria-describedby="contact-form-instructions" novalidate>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" class="form-input" placeholder="Votre nom complet" data-translate-placeholder="contact_name_placeholder" required aria-required="true" aria-labelledby="contact-name-label" autocomplete="name" minlength="2" maxlength="120">
                        </div>
                        <div class="mb-6">
                            ...
                            <input type="email" id="email" name="email" class="form-input" placeholder="votre.email@exemple.com" data-translate-placeholder="contact_email_placeholder" required aria-required="true" aria-labelledby="contact-email-label" autocomplete="email">
                        </div>
                        <div class="mb-6">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-input" placeholder="Votre numéro de téléphone (Optionnel)" data-translate-placeholder="contact_phone_placeholder" aria-labelledby="contact-phone-label" autocomplete="tel" pattern="^\+?[0-9\s.-]{6,}$" maxlength="25">
                        </div>
                        <div class="mb-6">
