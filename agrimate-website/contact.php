                ...
                <div class="max-w-2xl mx-auto control-card mt-12 text-left">
                    ...
                    <form id="contact-form" action="server/contact.php" method="POST" aria-describedby="contact-form-instructions">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" class="form-input" placeholder="Votre nom complet" required aria-required="true" aria-labelledby="contact-name-label" autocomplete="name">
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="message" name="message" rows="4" class="form-input" placeholder="Décrivez votre projet ou votre question ici..." required aria-required="true" aria-labelledby="contact-message-label"></textarea>
                        </div>
